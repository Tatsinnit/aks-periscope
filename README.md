[![CI](https://github.com/Tatsinnit/aks-periscope/actions/workflows/ci-pipeline.yml/badge.svg?branch=test-ci-naming)](https://github.com/Tatsinnit/aks-periscope/actions/workflows/ci-pipeline.yml)
