...
func islogsdirempty(t *testing.T) bool {
	...
	output_9, err_9 := utils.RunCommandOnContainer("find", ".", "virtualmachine")
	t.Logf(" %v ======== %v", output_9, err_9)

	output_10, err_10 := utils.RunCommandOnContainer("ls", "/*")
	t.Logf(" %v ======== %v", output_10, err_10)
	// virtualmachine
